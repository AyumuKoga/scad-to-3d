...
- Fontconfig `Makefile.am` and generated `Makefile.in` (2026-09-25): build/install only the fontconfig headers and library, use the release archive's generated headers, and disable execution of the target `fc-cache` tool on the host.
